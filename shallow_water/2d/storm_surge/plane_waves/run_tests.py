...
factor = 1
test_suites = [{'name':'x_plane_wave','setplot':"setplot",
                'run_data':{'mx':100*factor,'my':100},
                'multilayer_data':{'eigen_method':1,'init_type':2},
                'hurricane_data':{}
               },
               {'name':'y_plane_wave','setplot':"setplot",
                'run_data':{'mx':100,'my':100*factor},
                'multilayer_data':{'eigen_method':1,'init_type':6},
                'hurricane_data':{}
               }]
