...
c
      ...
      ! Calculate modified shelf geometry
      if (bathy_type == 2 .and. mtopofiles == 0) then
          ! Presecribed values
          x0 = 350d3 ! End of basin
          x1 = 450d3 ! Beginning of shelf
          x2 = 480d3 ! End of shelf, beginning of beach
          basin_depth = -3000d0
          shelf_depth = -100d0
          beach_slope = 0.05d0
          h = 10
