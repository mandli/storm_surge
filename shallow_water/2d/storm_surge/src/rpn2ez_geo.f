...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      double precision tau,wind,wind_speed,w_x,w_y
...
c               bL=hstartest+bR
         ...
         ! Calculate wind source term
         w_x = 0.5d0 * (auxl(i,4) + auxr(i-1,4))
         w_y = 0.5d0 * (auxl(i,5) + auxr(i-1,5))
         if (wind_forcing) then
             wind_speed = sqrt(w_x**2 + w_y**2)
             ...
             elseif (ixy == 2) then
                 ...
                 stop "ERROR in riemann solver, incorrect direction"
             endif
         endif
...
C          call riemann_fwave_stormsurge(meqn,mwaves,hL,hR,huL,huR,hvL,
C      &       hvR,bL,bR,uL,uR,vL,vR,phiL,phiR,sE1,sE2,drytol,tau,wind,
C      &       g,sw,fw)
