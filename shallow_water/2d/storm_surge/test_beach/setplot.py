...
#--------------------------
    ...
    def eye_location(current_data):
        t = current_data.t
        # Hurricane eye
        x = t * hurricane_data.hurricane_velocity_X + hurricane_data.R_eye_init_X
        y = t * hurricane_data.hurricane_velocity_Y + hurricane_data.R_eye_init_Y
    ...
    def bathy_ref_lines(current_data):
        ...
        for ref_line in [352e3,410e3,477e3]:
            plt.plot([ref_line,ref_line],y,'r-')
        plt.hold(False)
