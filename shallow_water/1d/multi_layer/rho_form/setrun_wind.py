...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        clawdata.tout = [0.1475e04,0.1477e04,0.1480e04,0.1482e04,0.1484e04,0.1484e04+dt,0.1484e04+dt*2.0]
...
def set_multilayer(run_data):
    ...
    prob_data.R_eye_init = 50e3
    prob_data.ramp_up_time = 0.0
    prob_data.sigma = 25e3
    
    if prob_data.wind_type == 4:
        prob_data.A = 20.0
