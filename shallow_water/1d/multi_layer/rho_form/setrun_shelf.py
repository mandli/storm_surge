...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        clawdata.tout = []
        for n in xrange(20):
            clawdata.tout.append(t_start + dt*n)
...
def set_multilayer(rundata):
    ...
    prob_data.rho_1 = 1025.0
    # prob_data.rho_2 = self.rho_1/0.99)
    prob_data.rho_2 = 1028.0
    
    # Algorithm
    # For linearized version, need higher tolerance...
    # prob_data.dry_tolerance = 1e-2
    # prob_data.eigen_method = 1
    
    # prob_data.dry_tolerance = 1e-3
    # prob_data.eigen_method = 2

    # Does not work with a dry bottom layer yet
    # prob_data.dry_tolerance = 1e-3
    # prob_data.eigen_method = 3
    ...
    prob_data.init_location = 300e3
    prob_data.wave_family = wave_family
    prob_data.eta_1 = 0.0
    prob_data.eta_2 = -4000
    # prob_data.epsilon = 0.027
    prob_data.epsilon = 0.4
    prob_data.sigma = 25e3
    
    # Bathymetry
    prob_data.bathy_location = -30e3
    prob_data.bathy_left = -4000.0
    prob_data.bathy_right = -200.0
